...
class GameOverScene extends Scene
  constructor: (score) ->
    ...
    if score > 1025 and score < 1077
      @label       = new Label("素晴らしい")
    else if score > 981 and score < 1122
      @label       = new Label("よくやった")
    else if score > 944 and score < 1161
      @label       = new Label("いいね")
    else if score > 912 and score < 1191
      @label       = new Label("まあまあだね")
    else if score > 872 and score < 1229
      @label       = new Label("もう少し")
    else if score > 832 and score < 1269
      @label       = new Label("まだまだだね")
    else
      @label       = new Label("ダメ")
