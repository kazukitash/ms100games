...
(function() {
  ...
  Traveler = (function(_super) {
    ...
    function Traveler(iraira) {
      Traveler.__super__.constructor.call(this, iraira[0], iraira[1]);
      this.image = core.assets[iraira[2]];
      this.frame = 0;
      this.moveTo(Math.random() * (HQ_GAME_WIDTH - this.width), Math.random() * (HQ_GAME_HEIGHT - this.height));
      this.life = 300;
  ...
  Travelers = (function(_super) {
    ...
    Iraira = [[60, 250, "iraira.png"], [175, 20, "iraira2.png"]];
