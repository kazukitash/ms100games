...
(function() {
  ...
  GameScene = (function(_super) {
    ...
    function GameScene() {
      ...
      this.number = (function() {
        ...
        for (num = _i = 1; _i <= 10; num = ++_i) {
          _results.push(Math.floor(Math.random() * 899 + 100));
        }
        return _results;
      })();
      sum = function(s) {
    ...
    GameScene.prototype.onenterframe = function() {
      if (this.age % 20 === 0 && this.n < 10) {
        ...
        core.gameOverScene = new GameOverScene(this.sum);
  ...
  GameOverScene = (function(_super) {
    ...
    function GameOverScene(sum) {
      ...
      this.sum = sum;
      this.number = [];
      this.number.push(this.sum);
      for (num = _i = 0; _i <= 2; num = ++_i) {
        this.number.push(this.sum + Math.floor(Math.random() * 999 - 400));
      }
      this.number.shuffle;
