...
(function() {
  ...
  Player = (function(_super) {
    ...
    function Player() {
      Player.__super__.constructor.call(this, 173, 56);
  ...
  GameOverScene = (function(_super) {
    ...
    function GameOverScene(sec) {
      ...
      this.label.moveTo((HQ_GAME_WIDTH - this.label.width) / 2 + 80, (HQ_GAME_HEIGHT - this.label.height) / 2);
