...
(function() {
  ...
  Player = (function(_super) {
    ...
    Player.prototype.ontouchstart = function() {
      if (this.jumpedAt > core.frame) {
        this.vy = -20;
        return this.jumpedAt = core.frame;
      }
    };
  ...
  GameScene = (function(_super) {
    ...
    function GameScene() {
      ...
      this.v = 0;
      this.bg = new Sprite(5400, HQ_GAME_HEIGHT);
    ...
    GameScene.prototype.scrolBack = function() {
      ...
      if (this.canBackScrol()) {
        this.bg.x -= this.v;
        _this = this;
        return this.hurdles.forEach(function(hurdle) {
          return hurdle.x -= _this.v;
        });
      } else {
    ...
    GameScene.prototype.onenterframe = function() {
      ...
      this.scrolBack();
      return this.hurdles.forEach(function(hurdle) {
        if (_this.player.intersect(hurdle) && !hurdle.hasHit) {
          hurdle.hasHit = true;
          return _this.v = 0;
        }
      });
