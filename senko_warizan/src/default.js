...
(function() {
  ...
  GameScene = (function(_super) {
    ...
    function GameScene() {
      ...
      this.addChild(this.bg);
      this.number = [];
      this.number.push(Math.floor(Math.random() * 8999999 + 1000000));
      for (num = _i = 1; _i <= 9; num = ++_i) {
        this.number.push(Math.floor(Math.random() * 9 + 1));
      }
      ans = function(s) {
  ...
  GameOverScene = (function(_super) {
    ...
    function GameOverScene(ans) {
      ...
      this.ans = ans;
      this.number = [];
      this.number.push(this.ans.toFixed(2));
      for (num = _i = 0; _i <= 2; num = ++_i) {
        this.number.push((this.ans + Math.random() * 20 - 10).toFixed(2));
      }
      this.number.shuffle;
