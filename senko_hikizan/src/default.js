...
(function() {
  ...
  GameScene = (function(_super) {
    ...
    function GameScene() {
      ...
      this.addChild(this.bg);
      this.number = [];
      this.number.push(Math.floor(Math.random() * 5999 + 4000));
      for (num = _i = 1; _i <= 9; num = ++_i) {
        this.number.push(Math.floor(Math.random() * 329 + 70));
      }
      ans = function(s) {
  ...
  GameOverScene = (function(_super) {
    ...
    function GameOverScene(ans) {
      ...
      for (num = _i = 0; _i <= 2; num = ++_i) {
        this.number.push(this.ans + Math.floor(Math.random() * 999 - 400));
      }
      this.number.shuffle;
